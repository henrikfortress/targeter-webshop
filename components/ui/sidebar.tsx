...
function Sidebar({
    ...
    if (collapsible === 'none') {
        return (
            <div data-slot="sidebar" className="relative shrink-0">
                <div data-slot="sidebar-gap" aria-hidden className="relative w-(--sidebar-width) bg-transparent" />
                <div
                    data-sidebar="sidebar"
                    className={cn(
                        'fixed inset-y-0 left-0 z-10 flex h-svh w-(--sidebar-width) flex-col border-r bg-sidebar text-sidebar-foreground',
                        className,
                    )}
                    {...props}
                >
